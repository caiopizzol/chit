// File-backed registry loader. Reads ~/.config/handoff/agents.json (or an
// explicit path), parses it via the browser-safe registry module, and
...
function defaultConfigPath(): string {
	...
	return join(xdg, "handoff", "agents.json");
}
