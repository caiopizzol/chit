...
- **Plan tools** run reviewed sequential work where later steps see earlier applied diffs: `chit_plan_start`, `chit_plan_status`, `chit_plan_advance`, `chit_plan_list`, `chit_plan_cancel`, `chit_plan_cleanup`.
