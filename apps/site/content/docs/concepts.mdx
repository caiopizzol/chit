...
- **Autonomous** - converge runs both agents to convergence against a git worktree (driven MCP-native with the `chit_converge_*` tools, or from a terminal with `chit converge`), and you inspect the result.
