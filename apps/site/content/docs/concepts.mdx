...
Plans and batches can select recipes by id. A dry run resolves the recipe to its
...
agent/model change forces re-approval or pauses the launch before a worker runs.
