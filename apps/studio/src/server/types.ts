...
// readers, and injected as a StudioLiveSource, so @chit-run/studio never imports
// CLI internals. A standalone Studio with no host returns an empty LiveActivity,
// not an error.
//
