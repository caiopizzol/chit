...
- *Migrated.* Repo directory (`/personal/handoff` → `/personal/chit`), root README, workspace package names (`chit-workspace`, `chit-cli`, `chit-docs`, `@chit/core`), CLI binary name (`chit`), CLI help and stderr prefixes, landing site and docs.
